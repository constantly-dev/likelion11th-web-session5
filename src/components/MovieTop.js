    ...
    <MovieTopContainer>
      <PosterContainer>
        ...
        <PosterAddContainer>
          <PosterAddUl>
            <MiniPosterBox>
              <MiniPoster src={data.img}></MiniPoster>
            </MiniPosterBox>
            <PosterAddBox>
              <PosterAdd>
                예매 순위 <strong>{data.rank}위(19%)</strong> 개봉{' '}
                <strong>14일째</strong> 누적 관객{' '}
                <strong>{data.audience}명</strong>
              </PosterAdd>
            </PosterAddBox>
          </PosterAddUl>
        </PosterAddContainer>
      ...
      <MovieTitleWrapper>
        ...
        <MovieTitleRight>
          <MovieTitleTitle>{data.title}</MovieTitleTitle>
          <MovieTitleYear>
            {data.year}・{data.genre}・{data.country}
          </MovieTitleYear>
          <MovieTitleStar>
            평균 ★{data.average} {''}@명
          </MovieTitleStar>
